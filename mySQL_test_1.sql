...
# project 4 on 7 april 2017 by delroy fong , cleston sanders , jim bui.
...
CREATE TABLE ITEM_SELL (
        ...
        item_sell_level_requirement SMALLINT UNSIGNED , # max lvl 999?
...
CREATE TABLE ITEM_BUY (
        ...
        item_buy_level_requirement SMALLINT UNSIGNED , # max lvl 999?
...
# FOR NOW MOST IF NOT ALL ID ARE AUTO-GENERATED STARTING FROM VALUE 1 (AUTO_INCREMENT tag).

# CUSTOMER TABLE.
INSERT INTO CUSTOMER (first_name , last_name , total_purchase , shipping_address)
VALUES 
    ('Harrison' , 'Ford' , '9001.50' , '6969 Kessel Station') ,
...
VALUES
    ('1' , 'Solaridus' , 'Store' , '10000000' , 'The Sun') ,
...
VALUES
    ('1' , 'Rusted Spear' , 'Spear' , '2500' , '20' , '99') ,
...
VALUES
    ('1' , 'Diamond Sword' , 'Sword' , '89000' , '90' , '10') ,
